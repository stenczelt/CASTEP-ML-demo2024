...
def mace_mp(
    ...
    **kwargs,
    ...
    elif model in (None, "small", "medium") or str(model).startswith("https:"):
        try:
            ...
            checkpoint_url = (
                ...
                if model in (None, "small", "medium")
                else model
            )
            # "/projappl/project_2010950/castep-ml/mace-cache"
            cache_dir = os.environ.get("MACE_CACHE_DIR") or os.path.expanduser("~/.cache/mace")
...
def mace_off(
    ...
    **kwargs,
    ...
    try:
        ...
        cache_dir = "/projappl/project_2010950/castep-ml/mace-cache"
